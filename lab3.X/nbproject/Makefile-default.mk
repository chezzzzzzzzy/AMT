...
SOURCEFILES_QUOTED_IF_SPACED=SPI.c delay.c Keypad.c SPI_LCD4.c segment_sandbox.c lcd_sandbox.c

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/SPI.p1 ${OBJECTDIR}/delay.p1 ${OBJECTDIR}/Keypad.p1 ${OBJECTDIR}/SPI_LCD4.p1 ${OBJECTDIR}/segment_sandbox.p1 ${OBJECTDIR}/lcd_sandbox.p1
POSSIBLE_DEPFILES=${OBJECTDIR}/SPI.p1.d ${OBJECTDIR}/delay.p1.d ${OBJECTDIR}/Keypad.p1.d ${OBJECTDIR}/SPI_LCD4.p1.d ${OBJECTDIR}/segment_sandbox.p1.d ${OBJECTDIR}/lcd_sandbox.p1.d

# Object Files
OBJECTFILES=${OBJECTDIR}/SPI.p1 ${OBJECTDIR}/delay.p1 ${OBJECTDIR}/Keypad.p1 ${OBJECTDIR}/SPI_LCD4.p1 ${OBJECTDIR}/segment_sandbox.p1 ${OBJECTDIR}/lcd_sandbox.p1

# Source Files
SOURCEFILES=SPI.c delay.c Keypad.c SPI_LCD4.c segment_sandbox.c lcd_sandbox.c
...
${OBJECTDIR}/SPI_LCD4.p1: SPI_LCD4.c  nbproject/Makefile-${CND_CONF}.mk
	...
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/SPI_LCD4.p1 SPI_LCD4.c 
	@-${MV} ${OBJECTDIR}/SPI_LCD4.d ${OBJECTDIR}/SPI_LCD4.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/SPI_LCD4.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/segment_sandbox.p1: segment_sandbox.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/segment_sandbox.p1.d 
	@${RM} ${OBJECTDIR}/segment_sandbox.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/segment_sandbox.p1 segment_sandbox.c 
	@-${MV} ${OBJECTDIR}/segment_sandbox.d ${OBJECTDIR}/segment_sandbox.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/segment_sandbox.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
	
${OBJECTDIR}/lcd_sandbox.p1: lcd_sandbox.c  nbproject/Makefile-${CND_CONF}.mk
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/lcd_sandbox.p1.d 
	@${RM} ${OBJECTDIR}/lcd_sandbox.p1 
	${MP_CC} $(MP_EXTRA_CC_PRE) -mcpu=$(MP_PROCESSOR_OPTION) -c  -D__DEBUG=1  -fno-short-double -fno-short-float -memi=wordwrite -O0 -fasmfile -maddrqual=ignore -xassembler-with-cpp -Wa,-a -DXPRJ_default=$(CND_CONF)  -msummary=-psect,-class,+mem,-hex,-file  -ginhx032 -Wl,--data-init -mno-keep-startup -mno-download -mdefault-config-bits $(COMPARISON_BUILD)  -std=c99 -gdwarf-3 -mstack=compiled:auto:auto:auto     -o ${OBJECTDIR}/lcd_sandbox.p1 lcd_sandbox.c 
	@-${MV} ${OBJECTDIR}/lcd_sandbox.d ${OBJECTDIR}/lcd_sandbox.p1.d 
	@${FIXDEPS} ${OBJECTDIR}/lcd_sandbox.p1.d $(SILENT) -rsi ${MP_CC_DIR}../  
